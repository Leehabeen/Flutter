...
class ImageSearch extends StatefulWidget{
  List? imageResult;
  ImageSearch({Key? key, @required this.imageResult}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _ImageSearch();
}

class _ImageSearch extends State<ImageSearch>{
  @override
        ...
        return Card(
          child: Column(
            children: <Widget> [
              ...
              Column(
                children: <Widget> [
                  Text('카데고리 : ${widget.imageResult![index]['collection']}'),
